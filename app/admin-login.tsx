...
import FancyBackground from './voter/FancyBackground'; // <-- Ensure path is correct
...
export default function AdminLogin() {
  ...
  return (
    <View style={styles.root}>
      ...
      {/* Optional gradient overlay (semi-transparent) */}
      <LinearGradient
...
/** Updated styles to separate background from the login card. */
